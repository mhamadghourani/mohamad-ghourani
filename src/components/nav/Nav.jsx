  ...
  return (
    <div className='nav'>
      <div className='nav-links'>
        <ul>
          <li><Link to="/" ><a href='/' onClick={(e) => handleNavigation(e, "/", "home")}>HOME</a></Link></li>
        ...
        <div className='logo'><img src="/public/logo.svg" alt="" onClick={(e) => handleNavigation(e, "/", "home")} /></div>
